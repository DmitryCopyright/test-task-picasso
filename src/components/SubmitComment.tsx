...
import type { IComment, ISendCommentFromProps } from '../types/CommentTypes';

export const SubmitComment = ({ postId }: ISendCommentFromProps) => {
    ...
    return (
        <>
            ...
            <Stack spacing={1}>
                ...
                <Button variant="contained" onClick={() => mutate()} disabled={isLoading}>Submit</Button>
            </Stack>
        </>
    );
}